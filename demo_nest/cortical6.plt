...
set ytics 40
set yrange [-100:60]
plot "voltmeter-".v1."-0.dat" using ($2):(f($3)) with lines lw 2 title "IN 1"
plot "voltmeter-".v2."-0.dat" using ($2):(f($3)) with lines lw 2 title "IN 2"
plot "voltmeter-".v3."-0.dat" using ($2):(f($3)) with lines lw 2 title "PY 1"
plot "voltmeter-".v4."-0.dat" using ($2):(f($3)) with lines lw 2 title "PY 2"
