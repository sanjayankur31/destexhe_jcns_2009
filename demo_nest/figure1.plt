...
plot "voltmeter-04-0.dat" using ($2):(f($3)) with lines lw 2 title "a = 0.001{/Symbol u}S, b = 0.02nA";
...
plot "voltmeter-07-0.dat" using ($2):(f($3)) with lines lw 2 title "a = 0.05{/Symbol u}S, b = 0nA";

set title "(f - top) RE cell"
plot "voltmeter-08-0.dat" using ($2):(f($3)) with lines lw 2 title "a = 0.08{/Symbol u}S, b = 0nA";
unset arrow
...
plot "voltmeter-10-0.dat" using ($2):(f($3)) with lines lw 2 title "a = 0.05{/Symbol u}S, b = 0nA";

set title "(f - bottom) RE cell"
plot "voltmeter-11-0.dat" using ($2):(f($3)) with lines lw 2 title "a = 0.08{/Symbol u}S, b = 0nA";
